...
#returns a list of x-ing centered bipyramid sizes from unfolding a petal knot p at index k.
#unfolding happens just 'above' the k^th strand (strands indexed starting at 0), k=1 is prepetal.  
...
#this is equal to the number of tetrahedra in face-centered bipyramids (less the outside face)
#for random permutations and large N, these seem to approach a normal distribution.
def sumdiff(a):
