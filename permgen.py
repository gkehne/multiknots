...
# this transitions from a petal permutation to the permutation of the
# petal from one 'roll'
def rotate(p):
...
# HELPER TO UGENER. Feasable up to about n=75 (around 8 seconds)
# (but it's a geometric random variable).
...
# HELPER TO UGENER through TIEUPKNOT. Recursively generates a
# parenthezation on 2*n elements
def tieup(n):
	if n < 0:
